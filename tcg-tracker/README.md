...
> **For AI assistants / future contributors:** read
> `SESSION_SUMMARY_v21_handoff.md` in this same folder FIRST, before
> making changes. It has the current project state, confirmed data facts,
> known gaps, and open items — skipping it risks re-deriving or
> re-breaking things already settled in prior sessions.
